...
This document is doesn't have any R code but recreates the core features of `connectwidgets` - providing a Python friendly way of creating custom aggregation pages!
:::
